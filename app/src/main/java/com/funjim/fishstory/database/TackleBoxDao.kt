...
interface TackleBoxDao {
    ...
    fun getTackleBoxForFisherman(fishermanId: Int): Flow<TackleBox?>

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertTackleBox(tackleBox: TackleBox): Long
    ...
    """)
    fun getLuresInTackleBox(tackleBoxId: Int): Flow<List<Lure>>
