...
data class TripEntityWithFishermen(
...
data class TripEntityWithFishermenAndSpecies(
    ...
    @Relation(
        ...
        entityColumn = "id",
        associateBy = Junction(
            value = TripTargetSpeciesEntity::class,
            parentColumn = "tripId",
...
data class TripEntityWithDetails(
    @Embedded val trip: TripEntity,
    ...
    val events: List<EventEntityWithInfo>,
...
data class TripEntityDetailedSummary(
    val id: String,
    val name: String,
    val startDate: Long,
    val endDate: Long,
